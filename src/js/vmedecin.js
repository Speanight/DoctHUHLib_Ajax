...
function activateDeleteButton(){
    ...
    buttons.forEach((b) => {
        b.addEventListener("click", () => {
            ...
            ajaxRequest("POST", "/espacedoc/delete", checkErrorMessage, "idDoc="+idDoc+"&idMeeting="+idMeeting); //Send the delete request - DELETE verb doesn't exist, default use REQUEST_METHOD POST in PHP
